class Solution:
    def countPrimes(self, n: int) -> int:
        ...
        for i in range(2, int(n ** 0.5)+1):     # change end to sqrt(n)
            if my_list[i]:  # i is prime
                for j in range(i * i, n, i):    # change start from 2*i to i*2, and that's solution_3
                    my_list[j] = False
            else:
                continue
...
"""
Runtime: 568 ms, faster than 57.42% of Python3 online submissions for Count Primes.
